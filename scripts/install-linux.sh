...
sudo install -Dm644 linux/50-spud-injection.pkla /etc/polkit-1/localauthority/50-local.d/50-spud-injection.pkla

echo "[install] Installing desktop entry"
sudo install -Dm644 linux/spud.desktop /usr/share/applications/spud.desktop
